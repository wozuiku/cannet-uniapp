			...
			<form>
				<view style="width: 100%;position:relative;height: 100vh;">
					...
					<view class="bg-gradual-blue"
						style="width: 100%;height: 330rpx; position: absolute;padding: 16rpx; border-bottom-left-radius: 20px;border-bottom-right-radius: 20px;background-color: #000000;">
					...
					<view style="width: 100%;height:100vh; position: absolute; margin-top: 140rpx; padding: 20rpx;">
						...
						<view>
							<view
								style="background: url(../../static/icons/bill_card.png) no-repeat;background-size: 100%;border-radius: 20rpx;width: 100%;height:380rpx ;padding: 45rpx;">
								<!-- 年月选择 -->
							...
							<!-- 抄表 -->
							<view class="cu-form-group flexcolumn"
								style="padding: 0rpx;padding-top: 20rpx; margin-top: 20rpx;border-radius: 10rpx;border-bottom: 1px solid #eee ;">
								<table width="100%">
									<tr
										...
										<td class="tdheader" width="40%"
											style="text-align: right;padding-right: 32rpx;">用电量<br>(kWh)</td>
									</tr>
									<tr>
										<td class="tdcontent" width="40%">201202020202</td>
										<td class="tdcontent" width="20%">200</td>
										<td class="tdcontent" width="40%"
											style="text-align: right;padding-right: 32rpx;">3443333.34</td>
									</tr>
								</table>
								<view class=" flexrowbetween"
									style="width: 100%;padding:0rpx 32rpx ; border-bottom: 1px solid #eee;">
									<view>
										<text>上次抄表：</text>
										<text>2021.12.1</text>
									</view>
								...
								<view style="padding:0rpx 32rpx ;width: 100%; position: relative;height: 200rpx;">
									<!-- 进度条 -->
									<view class="cu-progress round sm striped " style="position: absolute;top:33%">
										<view class="bg-green round"
											style=" background: linear-gradient(90deg, #39C678 0%, #FFD304 50%, #ff0000 100%);"
											:style="[{ width:loading?(progressNum+'%'):''}]"></view>
									</view>
									<!-- 进度条圆圈和数字区 -->
									<view :style="[{ 'margin-left':loading?(progressNum+1+'%'):''}]"
										style="background-color: #007AFF;">
										<!-- 进度条圆圈 -->
										<view
											style="top:30%;position: absolute;width:36rpx;height: 36rpx;background-color: #fff;border-radius: 50%;border: 1px solid #E0E0E0; ">
										</view>
										<!-- 进度条数字 -->
									...
									<view class="flexrowstart" style="position: absolute;top:50%;width: 100%;">
										<view class="flexcolumn" v-for="(item,index) in 3" :key="index"
							...
							<view class="cu-form-group flexcolumn" style="padding-top: 25rpx;border-radius: 10rpx;">
								...
								<table width="100%" style="margin-bottom: 39rpx;">
									<tr
										...
										<td class="td-typeheader" width="25%"
											style="text-align: right;padding-right: 16rpx;">电能量值<br>(kWh)</td>
